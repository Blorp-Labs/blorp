...
| `REACT_APP_DEFAULT_LIGHT_THEME`      | Default light theme for new users (`default-light`, `dracula-light`, `unix-light`) |
| `REACT_APP_DEFAULT_DARK_THEME`       | Default dark theme for new users (`default-dark`, `dracula-dark`, `unix-dark`)     |
